...
export const loadingSystem = (
    ...
    switch (action.type) {
        ...
        case LOADING_SYSTEM_ACTION_TYPES.SET_GLOBAL_LOADED:
            return { ...newState, isGlobalLoaded: (action as any).payload, isGlobalLoading: !(action as any).payload }
        ...
        case LOADING_SYSTEM_ACTION_TYPES.SET_LOCAL_LOADED:
            return { ...newState, isLocalLoaded: (action as any).payload, isLocalLoading: !(action as any).payload }
